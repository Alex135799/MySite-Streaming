   ...
   var createModule = function(angular) {
      ...
      module.factory('Fullscreen', ['$document', '$rootScope', function ($document,$rootScope) {
         ...
         $document.on('fullscreenchange webkitfullscreenchange mozfullscreenchange MSFullscreenChange', function(){
            emitter.$emit('FSFullscreen.change', serviceInstance.isEnabled());
         });
         ...
         return {
            link : function ($scope, $element, $attrs) {
               ...
               if ($attrs.fullscreen) {
                  ...
                  // Listen on the `FSFullscreen.change`
                  // the event will fire when anything changes the fullscreen mode
                  var removeFullscreenHandler = Fullscreen.$on('FSFullscreen.change', function(evt, isFullscreenEnabled){
